Module FTPFunctions
    ...
    Private Function FTPFolderIsOrphan(FolderUID As String) As FTPScan_Parms
        ...
        'Dim strQRYDev As String = "SELECT * FROM dev_attachments WHERE attach_dev_UID ='" & FolderUID & "'"
        'Dim strQRYSibi As String = "SELECT * FROM sibi_attachments WHERE sibi_attach_uid ='" & FolderUID & "'"
    ...
    Public Sub ScanAttachements()
        ...
        Try
            ...
            If intOrphanFiles > 0 Or intOrphanFolders > 0 Then
                Dim blah = MsgBox("Orphans found!  Folders:" & intOrphanFolders & "  Files:" & intOrphanFiles & vbCrLf & "See log for details:" & strLogPath, vbOKOnly + vbCritical, "Corruption Detected")
            Else
