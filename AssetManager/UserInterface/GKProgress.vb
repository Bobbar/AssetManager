...
Public Class GKProgress
    ...
    Private Sub ConnectNetworkDrive()
        ...
        Dim NetCon As New NetworkConnection(ClientPath, creds)
    ...
    Private Sub RunUpdate()
        Try
            ...
            '    Exit Sub
            'End If
            ''GKLog("Client Map: Remove Existing...")
            ''If RemoveClientDrive() Then
            ''    GKLog("Client Map: Existing map removed.")
            ''Else
            ''    GKLog("Client Map: No existing map.")
            ''End If
