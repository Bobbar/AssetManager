...
Public Class SibiMainForm
    ...
    Private Sub InitForm()
        Try
            ...
            Me.GridTheme = New GridTheme(Colors.HighlightBlue, Colors.SibiSelectColor, ResultGrid.DefaultCellStyle.BackColor)
    ...
    Private Function SibiTableColumns() As List(Of DataGridColumn)
        ...
        ColList.Add(New DataGridColumn(SibiRequestCols.Status, "Status", SibiAttribute.StatusType, ColumnFormatTypes.AttributeDisplayMemberOnly))
        ...
        ColList.Add(New DataGridColumn(SibiRequestCols.Type, "Request Type", SibiAttribute.RequestType, ColumnFormatTypes.AttributeDisplayMemberOnly))
