...
#Region "Methods"
    ...
    Public Function DeleteFtpAttachment(fileUID As String, fKey As String) As Boolean
        ...
        Try
            resp = DirectCast(FTPComms.ReturnFtpResponse("ftp://" & strServerIP & "/attachments/" & CurrentDB & "/" & fKey & "/" & fileUID, Net.WebRequestMethods.Ftp.DeleteFile), Net.FtpWebResponse)
    ...
    Public Function DeleteFtpFolder(folderUID As String) As Boolean
        Try
            ...
            If files.Count = i Then ' if successful deletetions = total # of files, delete the directory
                Using deleteResp = DirectCast(FTPComms.ReturnFtpResponse("ftp://" & strServerIP & "/attachments/" & CurrentDB & "/" & folderUID, Net.WebRequestMethods.Ftp.RemoveDirectory), Net.FtpWebResponse)
    ...
    Public Function HasFtpFolder(itemGUID As String) As Boolean
        Try
            Using resp As Net.FtpWebResponse = DirectCast(FTPComms.ReturnFtpResponse("ftp://" & strServerIP & "/attachments/" & CurrentDB & "/" & itemGUID & "/", Net.WebRequestMethods.Ftp.ListDirectory), Net.FtpWebResponse)
