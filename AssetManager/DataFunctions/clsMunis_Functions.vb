    ...
    Public Function Get_PO_From_Asset(AssetTag As String) As String
        Try
            If Not IsNothing(AssetTag) Then
                If AssetTag <> "" Then
                    Dim PO = priv_Comms.Return_MSSQLValue("famaster", "fama_tag", AssetTag, "fama_purch_memo")
    ...
    Public Function Get_PO_From_Serial(Serial As String) As String
        Try
            If Not IsNothing(Serial) Then
                If Serial <> "" Then
                    Dim PO = priv_Comms.Return_MSSQLValue("famaster", "fama_serial", Serial, "fama_purch_memo")
                    If PO IsNot Nothing Then
                        Return Trim(PO.ToString)
                    End If
                End If
