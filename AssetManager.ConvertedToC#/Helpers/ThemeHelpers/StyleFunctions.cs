...
namespace AssetManager
{
	static class StyleFunctions
	{
		...
		public static void HighlightRow(ref DataGridView Grid, GridTheme Theme, int Row)
		{
			try {
		...
		public static void LeaveRow(ref DataGridView Grid, GridTheme Theme, int Row)
		{
			Color BackColor = Theme.BackColor;
			Color SelectColor = Theme.CellSelectColor;
			if (Row > -1) {
